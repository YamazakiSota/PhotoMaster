...
#ifndef PHOTOMASTER_SWIFT_H
#define PHOTOMASTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PhotoMaster",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11PhotoMaster11AppDelegate")
...
SWIFT_CLASS("_TtC11PhotoMaster13SceneDelegate")
...
SWIFT_CLASS("_TtC11PhotoMaster14ViewController")
...
- (IBAction)onTappedCameraButton;
- (IBAction)onTappedAlbumButton;
- (IBAction)onTappedTextButton;
- (IBAction)onTappedIllustButton;
- (IBAction)onTappedUploadButton;
